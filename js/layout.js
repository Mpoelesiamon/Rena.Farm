    ...
    <div class="rf-nav-right">
      ...
      <div class="nav-account-wrap" id="accountWrap">
        <button class="nav-account-btn" id="accountBtn" aria-label="Account menu">
          <svg id="accountIcon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>
